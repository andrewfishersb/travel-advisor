...
public class CarTest{
  ...
  public void Car_instantiatesCar(){
    Car aCar = new Car("Today","Tomorrow",500,2,1,"PDX","SBA");
    assertTrue(aCar instanceof Car);
  }

  @Test
  public void Car_savesCarToDataBase_true(){
    Car aCar = new Car("Today","Tomorrow",500,2,1,"SBA","PDX");
    aCar.save();
    System.out.println("Car: "+aCar.getStartLocation());

    System.out.println("Size: "+Car.all().get(0).getStartLocation());
  ...
  public void Car_returnAllCars_true(){
    Car aCar = new Car("Today","Tomorrow",500,2,1,"PDX","SBA");
    Car anotherCar = new Car("Today","Tomorrow",55,2234,12,"PDX","SBA");
    aCar.save();
    anotherCar.save();
